        ...
        <div className="sm:hidden">
            ...
            <div className="w-full h-[62px] fixed bottom-0 z-30 left-0 bg-[#F7C548] flex justify-center items-center rounded-t">
                <ul className="flex w-[310px]">
                        ...
                        tabs.map(t => (
                            ...
                            >
                                <Link to={`/${t.title.toLowerCase()}`} className="relative flex justify-center items-center flex-col w-full text-center font-medium cursor-pointer">
                                    <span className={`relative top-5 block leading-[75px] h-[1.2em] w-[1.2em] text-[1.3em] text-center transition duration-500 text-[#04030F] ${t.title === active && 'transform -translate-y-8'}`}>
                                        {t.icon}
                                    </span>
                                    <span className={`absolute text-[#04030F] font-normal text-[.92em] tracking-[.05em] transition duration-500 trasform translate-y-11 opacity-0 ${t.title === active && 'translate-y-8 opacity-100'}`}>
                                        {t.title}
                                    </span>
                                </Link>
                            </li>
                    ...
                    <div className={`
                        absolute w-[62px] h-[62px] bg-[#1985A1] rounded-full border-[6px] border-[#FFFCFF] transition duration-500 -top-1/2
